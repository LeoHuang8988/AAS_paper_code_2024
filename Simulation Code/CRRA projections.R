...
source("Initial_proj_functions_CRRA.r")
...
Util_mat <- matrix(nrow = 1, ncol = 19) ##
colnames(Util_mat) <- c("Start.Bal", "Average.Final.Bal.s", "Average.Pretax.CEC.s", "Average.Posttax.CEC.s","Average.Final.Bal.h1", "Average.Pretax.CEC.h1", "Average.Posttax.CEC.h1", "Average.Final.Bal.b", "Average.Pretax.CEC.b", "Average.Posttax.CEC.b",
                        "Average.Final.Bal.h2", "Average.Pretax.CEC.h2", "Average.Posttax.CEC.h2", "Extra.Fee.Rate.h1.vs.s_cec", "Extra.Fee.Rate.h2.vs.s_cec", "Extra.Fee.Rate.s.vs.b_cec", 
                          "Extra.Fee.Rate.s.vs.b_cec", "Extra.Fee.Rate.h1.vs.b_cec", "Extra.Fee.Rate.h2.vs.b_cec")
