...
proj_CRRA_s <- function(bal_start, aa_decision, returnData, sim_year_total, vertical_size, alloboundL, alloboundU){
  ...
  Util.DF <- data.frame(Start.Bal = bal_start, Median.Final.Bal = median_end_bal, Mean.Final.Bal = mean_end_bal, Average.CEC = mean(sim_pseudoConsum))
...
proj_CRRA_h1 <- function(bal_start, aa_decision, returnData, sim_year_total, vertical_size, alloboundL, alloboundU){ 
  ...
  ## Construct a projection vector
  Util.DF <- data.frame(Start.Bal = bal_start, Median.Final.Bal = median_end_bal1, Mean.Final.Bal = mean_end_bal1, Average.CEC = mean(sim_pseudoConsum))##
